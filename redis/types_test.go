...
func TestRedisDataStructure_Get(t *testing.T) {
	...
	dir, _ := os.MkdirTemp("", "tinykv-go-redis-get")
	opts.DirPath = dir
	...
	assert.Equal(t, tinykv.ErrKeyNotFound, err)
}

func TestRedisDataStructure_Del_Type(t *testing.T) {
	opts := tinykv.DefaultOptions
	dir, _ := os.MkdirTemp("", "tinykv-go-redis-del-type")
	opts.DirPath = dir
	rds, err := NewRedisDataStructure(opts)
	assert.Nil(t, err)
...
func TestRedisDataStructure_HGet(t *testing.T) {
	opts := tinykv.DefaultOptions
	dir, _ := os.MkdirTemp("", "tinykv-go-redis-hget")
	opts.DirPath = dir
	rds, err := NewRedisDataStructure(opts)
	assert.Nil(t, err)
...
func TestRedisDataStructure_HDel(t *testing.T) {
	opts := tinykv.DefaultOptions
	dir, _ := os.MkdirTemp("", "tinykv-go-redis-hdel")
	opts.DirPath = dir
	rds, err := NewRedisDataStructure(opts)
	assert.Nil(t, err)
...
func TestRedisDataStructure_SIsMember(t *testing.T) {
	opts := tinykv.DefaultOptions
	dir, _ := os.MkdirTemp("", "tinykv-go-redis-sismember")
	opts.DirPath = dir
	rds, err := NewRedisDataStructure(opts)
	assert.Nil(t, err)
...
func TestRedisDataStructure_SRem(t *testing.T) {
	opts := tinykv.DefaultOptions
	dir, _ := os.MkdirTemp("", "tinykv-go-redis-srem")
	opts.DirPath = dir
	rds, err := NewRedisDataStructure(opts)
	assert.Nil(t, err)
...
func TestRedisDataStructure_LPop(t *testing.T) {
	opts := tinykv.DefaultOptions
	dir, _ := os.MkdirTemp("", "tinykv-go-redis-lpop")
	opts.DirPath = dir
	rds, err := NewRedisDataStructure(opts)
	assert.Nil(t, err)
...
func TestRedisDataStructure_RPop(t *testing.T) {
	opts := tinykv.DefaultOptions
	dir, _ := os.MkdirTemp("", "tinykv-go-redis-rpop")
	opts.DirPath = dir
	rds, err := NewRedisDataStructure(opts)
	assert.Nil(t, err)
...
func TestRedisDataStructure_ZScore(t *testing.T) {
	opts := tinykv.DefaultOptions
	dir, _ := os.MkdirTemp("", "tinykv-go-redis-zset")
	opts.DirPath = dir
	rds, err := NewRedisDataStructure(opts)
	assert.Nil(t, err)
